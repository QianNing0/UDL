...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/lupin/NQ/dataset',
...
parser.add_argument('--model', default='EDSR_two',
                    help='model name')
...
# Log specifications
parser.add_argument('--save', type=str, default='../experiment/X4/EDSR_s_step2_test',
...
# options for test
parser.add_argument('--testpath', type=str, default='/home/lupin/NQ/dataset/benchmark/Set5/LR_bicubic',
